...
/////////////////////////////////
// Key Differences: [Type aliases] can represent [primitive types], [union types], [intersection types], [tuples], etc., while <interfaces> are primarily used to represent the <shape of an object>.
