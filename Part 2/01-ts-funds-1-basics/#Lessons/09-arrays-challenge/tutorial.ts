...
// temperatures.push('hot'); // err

// 2. Create an array temperatures of type number[] and assign it some values. Then, try to add a string value to it.
let colors: string[] = ['red', 'green', 'blue']
// colors.push(true); // err
