...
/*
  - staff === manager 
    > CANNOT get "staff.department"
  - staff === manger 
    > CAN get "staff.employees"
  - staff === employee
    > CAN get "staff.department"
*/
function printStaffDetails(staff: Staff) {
  // *** use "in" to check > we need to pick the property in the object > 'employees' is the property of 'type Manager'
